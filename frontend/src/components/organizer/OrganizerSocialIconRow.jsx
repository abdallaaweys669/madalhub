...
import { getFilledOrganizerSocialLinks, toOpenableUrl } from '@/utils/socialLinks';
...
export default function OrganizerSocialIconRow({ profile, style, centered = true }) {
  const links = getFilledOrganizerSocialLinks(profile);
